...
namespace pbr
{
	...
	SimpleRenderSystem::SimpleRenderSystem(PbrDevice& device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout) : pbrDevice{ device }
	{
	...
	void SimpleRenderSystem::createPipeline(VkRenderPass renderPass)
	{
		...
		pbrPipeline = std::make_unique<PbrPipeline>(
			pbrDevice,
			"pbr/shaders/simple_shader.vert.spv",
			"pbr/shaders/simple_shader.frag.spv",
			pipelineConfig
		);
	}
